...
from learningplatform.views import CourseListCreateView, CourseDetailView, CourseDetailBySlugView, set_teacher_role, check_user_role, FirebaseLoginView, VerifyFirebaseTokenView, SetTeacherRoleView, UserListView, assign_course, my_courses, teacher_course_detail
